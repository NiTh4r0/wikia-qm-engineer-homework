...
public class WikiaHomeworkPage extends WikiaBasePage {
  ...
  public boolean getContributeDropdownVisibility() {
    return WikiaMenuElement.isDisplayed();
  }
  ...
  public WikiaAddVideoPage clickAddVideoLink() throws NullPointerException {
    ...
    WebElement addVideoLink = WebElementHelper.findLinkElementByHref(getDriver(),
        "WikiaVideoAdd");
    ...
    new WebDriverWait(getDriver(), Duration.of(10, ChronoUnit.SECONDS)).until(
        ExpectedConditions.presenceOfElementLocated(By.id("wpWikiaVideoAddUrl")));
